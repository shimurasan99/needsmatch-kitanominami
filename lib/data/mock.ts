...
const memberRows = [
  ...
  ["4797", "浅里 綾夏", "株式会社グロウ", "美容商材ディーラー事業部卸", "幹事"],
  ["656", "飛山 佳枝", "アイボットデザイン合同会社", "広告制作、営業塾運営", "幹事"],
  ...
  ["4794", "野口 貴之", "ラディックス株式会社", "DX推進事業", "幹事"],
  ["4881", "向畑 太輔", "thankfulwork", "ファッションスタイリスト", "幹事"],
  ["5235", "菅咲 伎桂", "開成結社", "宗教", "幹事"],
