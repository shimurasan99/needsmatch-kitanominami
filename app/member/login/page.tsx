    ...
    <section className="mx-auto max-w-md px-4 py-16">
      <div className="rounded border border-slate-200 bg-white p-6 shadow-soft">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-600">
          会員専用ページと運営専用ページは共通パスワードで保護しています。開発用パスワードは admin です。
        </p>
        {searchParams.error && (
        ...
        <form action="/api/login" method="post" className="mt-6 grid gap-5">
          ...
          <label className="block">
            <span className="text-sm font-bold">共通パスワード</span>
            <input name="password" type="password" placeholder="admin" className="focus-ring mt-2 w-full rounded border border-slate-200 px-3 py-3" />
          </label>
